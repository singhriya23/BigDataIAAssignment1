...
if dropdown == "PyMuPDF":
    ...
    if uploaded_file is not None:
        # ✅ Preserve the correct filename
        original_filename = uploaded_file.name
        file_name, file_extension = os.path.splitext(original_filename)  

        # ✅ Send file with correct filename to FastAPI
        ...
        if response.status_code == 200:
            try:
                ...
                # ✅ Use correct S3 folder structure based on uploaded file name
                ...
                if st.button("Download Full Processed Folder"):
                    ...
                    try:
                        # ✅ List all objects inside the correct folder in S3
                        ...
                        if "Contents" not in objects:
                            ...
                            with zipfile.ZipFile(local_zip_path, "w") as zipf:
                                for obj in objects["Contents"]:
                                    ...
                                    os.remove(local_file_path)  # ✅ Cleanup after download
    ...
    if uploaded_file is not None:
        # ✅ Preserve correct filename
        original_filename = uploaded_file.name
        file_name, file_extension = os.path.splitext(original_filename)

        # ✅ Send file with the correct name to FastAPI
        files = {"file": (original_filename, uploaded_file.getvalue(), uploaded_file.type)}
                ...
                if st.button("Download Full Processed Folder"):
                    ...
                    try:
                        ...
                        if "Contents" not in objects:
                            ...
                            # ✅ Download all files from the correct folder and zip them locally
                            import zipfile
                            with zipfile.ZipFile(local_zip_path, "w") as zipf:
                                for obj in objects["Contents"]:
                                    key = obj["Key"]
