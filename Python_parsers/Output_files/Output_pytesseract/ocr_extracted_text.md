...
```
[Library |[rext Extraction||Tables||Images locR Support|Manipulation|

pyppF2___fiv >< |x| Iv |
[pdfplumber |v IY |[Limiteal|X [Xx |
|pyMuPDF (fitz)||V | a lv |
[Camelot |X | A |S 2 x |
...
[Pytesseract |v (OCR-based) x Iv |v [Xx |
...
```
References
. Hessie Jones. (2024, June 21). Parsing the future: The promises and perils of large
language models. Forbes. Retrieved from

https://www.forbes.com/sites/hessiejones/2024/06/2 1/parsing-the-future-the-

promises-and-perils-of-large-language-models/

. Appy Pie. (n.d.). Ethics and bias in LLMs. Retrieved from

https://www.appypie.com/blog/ethics-and-bias-in-llms

. Labellerr. (n.d.). Challenges in the development of LLMs. Retrieved from
https://www. labellerr.com/blog/challenges-in-development-of-I|ms/

. Segmind. (n.d.). Understanding the generative AI compute requirements: LLMs vs.

diffusion models. Retrieved from https://blog.segmind.com/understanding-the-gen-ai-

compute-requirements-I|ms-vs-diffusion-models/

. GeeksforGeeks. (n.d.). Large language models (LLMs). Retrieved from

https://www.geeksforgeeks.org/large-language-model-Im/

. Run:Al. (n.d.). LLM training. Retrieved from https://www.run.ai/guides/machine-

learning-engineering/Ilm-training

. Huang, P., et al. (2023). Understanding generative AI compute requirements. arXiv
